    ...
    return Scaffold(
                      ...
                      children: [
                        ...
                        if (resultatTraduction != "" && !ecoute)
                          GestureDetector(
                            onTap: () {
                              speak(
                                  langueArriver.abreger!, resultatTraduction!);
                            },
                            child: Container(
                        ...
                        if (resultatTraduction != "" && !ecoute)
                          IconButton(
                            onPressed: () {
                              FlutterClipboard.copy(resultatTraduction!).then(
                                (value) =>
      ...
      floatingActionButton: AvatarGlow(
        ...
        child: FloatingActionButton(
          ...
          child: Icon(ecoute ? Icons.mic_rounded : Icons.mic_none_rounded),
        ),
      ),
